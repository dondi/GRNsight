...
describe ("Import from SIF syntactic checker", function () {
    ...
    it("should generate a warning if the data is comma separated", function() {
      expect(importController.sifToGrnsight(unweightedTestSifCommaSeparated).errors[0].warningCode
    ...
    it ("should generate a warning for SIF files with one source node although this is still a valid network", function () {
      expect(
