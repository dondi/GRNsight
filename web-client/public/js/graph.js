    ...
    link.append("path")
      ...
      .attr("id", function (d) {
          ...
          if ( $("#" + d.type + selfRef + "_StrokeWidth" + d.strokeWidth + minimum).length !== 0 ) {
              ...
              // If negative, you need one bar for horizontal and one for vertical. If the user is not coloring
              // the weighted sheets, then we make all of the markers arrowheads.
 ...
 */
    ...
    var text = node.append("text") // eslint-disable-line no-unused-vars
        .attr("dy", 22)
        .attr("text-anchor", "middle")
