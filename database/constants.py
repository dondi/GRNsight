class Constants:
    ...
    PROTEIN_MISSING_GENE_DIRECTORY = PROTEIN_FOLDER_PATH + '/script-results/processed-loader-files/missing-genes.csv'
    PROTEIN_UPDATE_GENE_DIRECTORY = PROTEIN_FOLDER_PATH + '/script-results/processed-loader-files/update-genes.csv'
    PROTEIN_MISSING_PROTEIN_DIRECTORY = PROTEIN_FOLDER_PATH + '/script-results/processed-loader-files/missing-proteins.csv'
    PROTEIN_UPDATE_PROTEIN_DIRECTORY = PROTEIN_FOLDER_PATH + '/script-results/processed-loader-files/update-proteins.csv'
    
    NETWORK_MISSING_GENE_DIRECTORY = NETWORK_FOLDER_PATH + '/script-results/processed-loader-files/missing-genes.csv'
    NETWORK_UPDATE_GENE_DIRECTORY = NETWORK_FOLDER_PATH + '/script-results/processed-loader-files/update-genes.csv'