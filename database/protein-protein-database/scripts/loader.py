...
def LOAD_PHYSICAL_INTERACTIONS():
    print('COPY protein_protein_interactions.physical_interactions (protein1, protein2, interaction_detection_methods_identifier, experiment_name) FROM stdin;')
    ...
    with open(NETWORK_SOURCE, 'r+') as f:
        ...
        for row in reader:
            if row_num != 0:
                ...
                idmi = r[2]
                exp_name = r[3]
                print(f'{protein1}\t{protein2}\t{idmi}\t{exp_name}')
            row_num += 1
    print('\\.')
