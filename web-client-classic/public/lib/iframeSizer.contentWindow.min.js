...
!(function (l) {
        ...
        !(function () {
            ...
            (function () {
                function e(e, t) {
                    return (
                        "function" == typeof e &&
                            (ae("Setup custom " + t + "CalcMethod"), (H[t] = e), (e = "custom")),
                        e
                    );
                }
            ...
            (y = (function () {
                ...
                function n(e) {
                    ...
                    l !== i
                        ? ((t = r(i)),
                          ae("Moving to in page link (#" + n + ") at x: " + t.x + " y: " + t.y),
    ...
    function me(e, t, n, o) {
        return (
            t !== e &&
                (e in n ||
                    (ue(e + " is not a valid option for " + o + "CalculationMethod."), (e = t)),
    ...
    function we(e, t) {
        for (var n, o = t.length, i = 0, r = 0, a = ie(e), u = Z(), c = 0; c < o; c++)
            r < (i = t[c].getBoundingClientRect()[e] + be("margin" + a, t[c])) && (r = i);
        return (
            (u = Z() - u),
            ae("Parsed " + o + " HTML elements"),
            ae("Element position calculated in " + u + "ms"),
            R / 2 < (n = u) && ae("Event throttle increased to " + (R = 2 * n) + "ms"),
            r
        );
    }
    function Te(e) {
    ...
    function Se(e, t, n, o) {
        ...
        !(function () {
            ...
            return (
                (i = l !== n ? n : $[g]()), (r = l !== o ? o : _[F]()), e(m, i) || (c && e(x, r))
            );
        })() && "init" !== e
    ...
    function ke(t) {
        var n = {
            ...
            pageInfo: function () {
                var e = i();
                ae("PageInfoFromParent called from parent: " + e), q(JSON.parse(e)), ae(" --");
            },
            message: function () {
                var e = i();
        ...
        T === ("" + t.data).substr(0, E) &&
            (!1 === f
                ...
                : r()
                  ? n.init()
                  : ae('Ignored message of type "' + o() + '". Received before initialization.'));
    }
    function ze() {
