...
var demoNetwork1 = function(path, res, app) {
  ...
  return processDemo(path, res, app, network);
};
        ...
        errors: [
          {
            ...
            possibleCause:
                "The top left cell of the expression sheet is mislabeled.",
            suggestedFix: "Replace the incorrect label with 'id' exactly."
          }
        ],
        warnings: [],
        timePoints: ["StandardName", 0, 10, 30, 120],
        data: {
          SystematicName: ["StandardName", 0, 10, 30, 120],
          YKL112W: [
            "ABF1",
            2.717774879866106,
            0.27986899329141984,
...
module.exports = function() {
  return {
    demoNetwork1: demoNetwork1,
    demoNetwork2: demoNetwork2,
    demoNetwork3: demoNetwork3,
    demoNetwork4: demoNetwork4,
  };
};
